#!/bin/sh
# $Id: mod_ssl-gentestcrt.sh 92365 2007-09-23 14:04:27Z oden $
# $HeadURL: http://svn.mandriva.com/svn/packages/cooker/apache-conf/current/SOURCES/mod_ssl-gentestcrt.sh $
##
